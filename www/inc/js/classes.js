...
//var Charlie = new Character("CIA Charlie", 10, "inc/images/character_ciacharlie.jpg", "Counter-Terrorist", "counter_terrorist_win_condition", "special", "All the Terrorists are dead.", "Reveal - When you move you can roll dive as normal or move to an adjacent area (Including the Safe House).");
var Charlie = new Character("CIA Charlie", 10, "inc/images/character_ciacharlie.jpg", "Counter-Terrorist", "counter_terrorist_win_condition", "special", "All the Terrorists are dead.", "Reveal - Once only, fully heal your damage.");
//var Fred = new Character("FBI Fred", 12, "inc/images/character_fbifred.jpeg", "Counter-Terrorist", "counter_terrorist_win_condition", "special", "All the Terrorists are dead.", "Once only, at the start of your turn you pick any player and give them 1D6 damage (No defense roll).");
var Fred = new Character("FBI Fred", 12, "inc/images/character_fbifred.jpeg", "Counter-Terrorist", "counter_terrorist_win_condition", "special", "All the Terrorists are dead.", "Once only, at the start of your turn you pick any player to inflict a random damnage between 1-6.");
...
//var George = new Character("Gatherin' George", 10, "inc/images/character_gatheringeorge.png", "Neutral", "win_condition", "special", "When you have more than 5 equipment cards.", "Reveal - If you inflict 2 or more damage, you can take an equipment card of your choice instead of doing the damage.");
